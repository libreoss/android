 ...
 * Drugi TAB
 */
public class DrugiTabInfo extends SherlockListFragment {
	...
	private void refresujListu() {
		// TODO implementacija INFO refreša
		Toast.makeText(getActivity(), "Refrešujem INFO...", Toast.LENGTH_SHORT).show();
	}
}
